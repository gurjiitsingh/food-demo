    ...
    >
      ...
      <div className="px-4  flex flex-col justify-between flex-1">
        <div className="flex-1">
          {/* Title */}
          <h3
            className={`${fontTitle.className} py-0 min-h-10  text-sm font-semibold text-slate-500 leading-snug line-clamp-2`}
          >
          ...
          {product.productDesc && (
            <p
              ...
              className={`${fontDescription.className}  h-5 overflow-hidden text-sm text-gray-500 mt-1 line-clamp-3 cursor-pointer`}
            >
              {product.productDesc}
            </p>
          )}
        ...
        <div className="">
          {!product.flavors && (
            <div className="flex items-center justify-between">
              ...
              {priceDiscounted ? (
                <div
                  className={`${fontPrice.className} flex w-full items-end gap-4  text-sm font-medium text-gray-900`}
                >
                  <div className="text-slate-500 font-bold text-[15px]">
                    {priceDiscounted}
                  </div>
                  <div className="line-through text-gray-500  text-[12px] font-normal">
                    {priceRegular}
                  </div>
                </div>
              ) : (
                <div
                  className={`${fontPrice.className} text-slate-500 font-bold text-[15px]`}
                >
                  {priceRegular}
                </div>
              )}
